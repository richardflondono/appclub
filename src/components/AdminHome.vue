                    ...
                    <div id="sub-menu2" class="container tab-pane">
                        ...
                        <tr>
                            ...
                            <hr style="border:8px; background:red">
                                ...
                                <h4 style="color: #FBB829">10 Miembros registrados</h4>
    ...
    <div class="column-3"><!-- Tercera col -->
        <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
                ...
                <div id="menu_form" class="container tab-pane active"><!--- Crear usuario -->
                    <h3>Crear usuario</h3>
                    <p>
                      Sed ut perspiciatis unde omnis iste natus
                      error sit voluptatem accusantium doloremque
                ...
                <div id="menu_form2" class="container tab-pane "><!--- Información -->
                  <h3>Informacion</h3>
                  ...
                  <a href="">Andres Salazar</a>
                          ...
                          <h6>Estado:</h6>
                                ...
                                <p>
                                  ...
                                  Maecenas at massa eros. Nullam a vulputate dolor.
                                  Quisque a metus ut quam eleifend aliquet non non urna.
                                </p>
                                ...
                                <ul>
                                    <li>320 Vidas impactadas</li>
                                    <li>7 Vuelos</li>
                                    <li>250 Elevaciones</li>
                                    <li>68 Angeles activos</li>
                                </ul>
